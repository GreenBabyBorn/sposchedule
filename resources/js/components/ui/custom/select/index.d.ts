...
export declare type SelectPassThroughOptionType<T = any> =
  | SelectPassThroughAttributes
  | ((
      options: SelectPassThroughMethodOptions<T>
    ) => SelectPassThroughAttributes | string)
  | string
  | null
  | undefined;

export declare type SelectPassThroughTransitionType<T = any> =
  | TransitionProps
  | ((options: SelectPassThroughMethodOptions<T>) => TransitionProps)
  | undefined;
...
export interface SelectProps {
   ...
   */
  filterMatchMode?:
    | HintedString<'contains' | 'startsWith' | 'endsWith'>
    | undefined;
  /**
